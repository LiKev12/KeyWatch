...
class Dashboard extends Component{
    ...
    handleToggleTimeView(tabId) {
        ...
        if (tabId < 4) {
            ...
            timeQuery = 'http://127.0.0.1:5000?start_date=' + start + '&end_date=' + end;
        } else {
            timeView = 'All'
    ...
    async componentDidMount() {
        ...
        try {
            setInterval(async () => {
                ...
                const response = await fetch(this.state.timeViewURL,
                    {
                        headers : { 
    ...
    render() {
        return (
            <div className="Dashboard">
                <h1> Hello, Jackie.</h1>
                <h4> <b>Today is {moment().format('LL')}.</b></h4>
                <br></br><br></br>
                <p>See your recent activity.</p>
                <br></br>

                <div className="demo-tabs">
                    <Tabs activeTab={this.state.activeTab} onChange={(tabId) => this.handleToggleTimeView(tabId)} ripple>
                        <Tab>Day</Tab>
                        <Tab>Week</Tab>
                        <Tab>Month</Tab>
                        <Tab>Year</Tab>
                    ...
                    <section>
                        <div className="content"><h4>Viewing: {this.state.timeView}</h4></div>
                    </section>
                </div> 
